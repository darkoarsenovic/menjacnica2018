...
public class ObrisiKursGUI extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6393851084765055613L;
	...
	private void prikaziValutu() {
		...
		textFieldNaziv.setText(GUIKontroler.valuta.getNaziv());
		textFieldSkraceniNaziv.setText(GUIKontroler.valuta.getSkraceniNaziv());
		textFieldSifra.setText(String.valueOf(GUIKontroler.valuta.getSifra()).toString());
		textFieldProdajniKurs.setText(String.valueOf(GUIKontroler.valuta.getProdajni()).toString());
		textFieldKupovniKurs.setText(String.valueOf(GUIKontroler.valuta.getKupovni()).toString());
		textFieldSrednjiKurs.setText(String.valueOf(GUIKontroler.valuta.getSrednji()).toString());
	}
}
